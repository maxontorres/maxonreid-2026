      ...
      <main className="min-h-screen" style={{ background: 'var(--bg-primary)' }}>
        ...
        <section className="pt-32 pb-0 w-[92%] max-w-[1200px] mx-auto">
          ...
          <div className="flex items-center gap-2 font-mono text-sm text-[#8A8FA0] mb-10">
            ...
            <span>/</span>
            <span className="text-[#628DFF]">OrderBridge</span>
          </div>
          ...
          <h1 className="text-5xl md:text-7xl font-bold text-[#E8E9EC] leading-none mb-6">
            Order<span className="text-[#628DFF]">Bridge</span>
          </h1>
          ...
          <div className="flex flex-wrap gap-4 mb-16">
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 border border-white/[0.06] text-[#8A8FA0] px-6 py-3 rounded-lg font-mono text-sm hover:border-[#628DFF]/50 hover:text-[#E8E9EC] transition-all"
            >
              {t('readBuildArticle')}
              <span aria-hidden="true">↗</span>
            </Link>
          ...
          <figure className="rounded-2xl overflow-hidden border border-white/[0.06] mt-8">
            ...
            />
            <figcaption className="font-mono text-xs text-[#8A8FA0] text-center py-3 border-t border-white/[0.06] bg-white/[0.02]">
              {t('diagramCaption')}
            </figcaption>
          </figure>
        </section>
